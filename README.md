...
- Add timestamps automatically to new devnotes inside of content
- Add append feature that quickly adds a few lines without opening up an interactive editor
- Create simple Django rest framework server to receive and store devnotes
